...
{* -----------------------------title------------------------------------ *}{...}
{p 0 17 2}
{bf:[W-20] lpoly1_1} {hline 2} Perform one-dimensional local polynomial regression like {help lpoly}, but more coefficients can be additionally obtained. You can view source code in {browse "https://github.com/Meiting-Wang/lpoly1":github}.
...
{p 8 10 2}
{cmd:lpoly1_1} {it:{help varname:yvar}} {it:{help varname:xvar}}, {opth at:(varname)} [{opth ker:nel(lpoly1_1##Kernel:kernel)} {opt bw:idth(real>0)} {opt d:egree(integer>=0)} {opth keep:(strings:string)}]
...
{p 4 4 2}
{help lpoly1_1##Description:Description}{break}
{help lpoly1_1##Options:Options}{break}
{help lpoly1_1##Kernel:Kernels}{break}
{help lpoly1_1##Examples:Examples}{break}
{help lpoly1_1##Author:Author}{break}
{help lpoly1_1##Also_see:Also see}{break}
...
{p 4 4 2}
{cmd:lpoly1_1} can perform one-dimensional local polynomial regression like {help lpoly}, but derivatives of the fitted value with respect to the independent variable with different orders can be additionally obtained.
...
{synopt :{opth ker:nel(lpoly1_1##Kernel:kernel)}}Specify the kernel function, {bf:gaussian} as the default.{p_end}
...
{p 8 10 2}. {bf:lpoly1_1 Y X, at(x) bwidth(0.1) degree(3) kernel(gaussian)}{p_end}
